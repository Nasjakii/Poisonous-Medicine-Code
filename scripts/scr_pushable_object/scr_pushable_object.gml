...
function scr_pushable_object(x1 = 0,y1 = 0,width = sprite_width, height = sprite_height){
	
	var x_offset = x1 * image_xscale;
	var y_offset = y1 * image_yscale;

	var inst = instance_create_layer(x + x_offset,y + y_offset,"Invisible", objPushable);
